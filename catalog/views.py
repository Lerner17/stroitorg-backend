...
from .models import Product, Category, Thickness
from .serializers import ProductSerializer, CategoryListSerializer, CategoryDetailSerializer, ThicknessSerializer
